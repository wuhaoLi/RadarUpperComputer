...
void cloud_cb (const sensor_msgs::PointCloud2ConstPtr& input)
{
  ...
  { 
    ...
    sor.setMeanK(80); // 点数    
    sor.setStddevMulThresh(0.5); //阈��1�7   
    ...
    pcl::search::KdTree<pcl::PointXYZINormal>::Ptr kdtree(new pcl::search::KdTree<pcl::PointXYZINormal>);
	  ...
	  ec.setClusterTolerance(0.8); // 设置欧氏聚类的容差，聚类时允许的点之间的朢�大距禄1�7
	  ec.setMinClusterSize(20);    // 设置聚类的最小点敄1�7
	  ec.setMaxClusterSize(500);  // 设置聚类的最大点敄1�7
