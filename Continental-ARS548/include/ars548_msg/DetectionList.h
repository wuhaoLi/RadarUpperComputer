...
struct DetectionList_
{
  ...
  _List_InvalidFlags_type List_InvalidFlags;
   ...
   typedef std::vector< ::ars548_msg::detections_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ars548_msg::detections_<ContainerAllocator> >::other >  _detection_array_type;
