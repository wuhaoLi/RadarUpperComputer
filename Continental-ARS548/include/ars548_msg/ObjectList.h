...
struct ObjectList_
{
  ...
  _ObjectList_NumOfObjects_type ObjectList_NumOfObjects;
   ...
   typedef std::vector< ::ars548_msg::objects_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::ars548_msg::objects_<ContainerAllocator> >::other >  _object_array_type;
